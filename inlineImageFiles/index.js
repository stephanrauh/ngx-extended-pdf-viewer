...
lineReader
  ...
  .on('close', function() {
    fs.writeFile('../projects/ngx-extended-pdf-viewer/src/lib/viewer-with-images-2.2.222.css', result, function(err) {
      if (err) {
        return console.log(err);
      }

      console.log('The file was saved to ../projects/ngx-extended-pdf-viewer/src/lib/viewer-with-images-2.2.222.css!');
    });
  });
