...
- [CVE-2026-16633](https://github.com/mozilla/pdf.js/security/advisories/GHSA-hq66-cqwq-w95j) (pdf.js, high, published 2026-07-28): a malicious PDF could execute JavaScript in the context of the hosting page. It affects pdf.js from 5.6.83 onwards, so every ngx-extended-pdf-viewer release from 27.0.0 on is affected. **Version 28.1.1 fixes this** on the 28.x line by cherry-picking Mozilla's fix (pdf.js 6.2.108) into the bundled 6.0 engine.
