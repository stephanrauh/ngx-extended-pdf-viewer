...
3. ✓ Update version in mypdf.js (both 5.6.205 and bleeding-edge branches)
...
4. Runs `npm run do-release:lib` which:
   ...
   - Builds base library from mypdf.js 5.6.205
...
- ✅ **Stable (5.6.205) assets** - Verifies same 9 critical files exist and are >= 700 KB each
