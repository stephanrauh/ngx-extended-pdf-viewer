...
3. ✓ Update version in mypdf.js (both 6.0 and bleeding-edge branches)
...
4. Runs `npm run do-release:lib` which:
   ...
   - Builds base library from mypdf.js 6.0
...
- ✅ **Stable (6.0) assets** - Verifies same 9 critical files exist and are >= 700 KB each
