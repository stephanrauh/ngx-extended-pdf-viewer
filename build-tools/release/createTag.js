...
// Checkout 5.6.205 branch
runCommand('git checkout 5.6.205', 'Error checking out 5.6.205 branch:');
console.log('Checked out 5.6.205 branch.');
// Commit changes in 5.6.205 branch
runCommand(`git commit -a -m "published ${version}"`, 'Error committing changes in 5.6.205 branch:');
console.log('Committed changes in 5.6.205 branch.');
runCommand('git push', 'Error pushing changes in 5.6.205 branch:');
console.log('Pushed changes in 5.6.205 branch.');

// Create and push tag for 5.6.205
runCommand(`git tag -a "ngx-extended-pdf-viewer-${version}" -m "ngx-extended-pdf-viewer ${version}"`, 'Error creating 5.6.205 tag in mypdf.js:');
console.log(`Created 5.6.205 tag: ngx-extended-pdf-viewer-${version}`);
runCommand('git push origin --tags', 'Error pushing 5.6.205 tag in mypdf.js:');
console.log('Pushed 5.6.205 tag in mypdf.js.');
