...
// Checkout 4.10 branch
runCommand('git checkout 4.10', 'Error checking out 4.10 branch:');
console.log('Checked out 4.10 branch.');
// Commit changes in 4.10 branch
runCommand(`git commit -a -m "published ${version}"`, 'Error committing changes in 4.10 branch:');
console.log('Committed changes in 4.10 branch.');
runCommand('git push', 'Error pushing changes in 4.10 branch:');
console.log('Pushed changes in 4.10 branch.');

// Create and push tag for 4.10
runCommand(`git tag -a "ngx-extended-pdf-viewer-${version}" -m "ngx-extended-pdf-viewer ${version}"`, 'Error creating 4.10 tag in mypdf.js:');
console.log(`Created 4.10 tag: ngx-extended-pdf-viewer-${version}`);
runCommand('git push origin --tags', 'Error pushing 4.10 tag in mypdf.js:');
console.log('Pushed 4.10 tag in mypdf.js.');
