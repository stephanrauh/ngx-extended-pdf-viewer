...
class PDFFindController {
  ...
  scrollMatchIntoView({
    ...
    (0,ui_utils.scrollIntoView)(element, spot, true, this._pageViewMode === 'infinite-scroll');
  }
  #reset() {
...
const pdfjsVersion = "4.1.896";
const pdfjsBuild = "99a19892a";
const AppConstants = {
