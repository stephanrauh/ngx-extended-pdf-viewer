...
- Version 24.2.0 and above:
  ...
  - **Page Reordering Feature**: New `enablePageReordering` option allows users to reorder PDF pages by dragging thumbnails. Enable with `pdfDefaultOptions.enablePageReordering = true;`.
