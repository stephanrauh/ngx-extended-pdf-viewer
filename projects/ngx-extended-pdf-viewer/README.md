...
| [printResolution]            |       150       | set the print resolution in DPI. Sensible values are 300, 600, and maybe even 1200. Note that higher values result in more memory consumption, more CPU uses, and may even cause browser crashes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- 1.2.0 #127 add an option for setting the print resolution; #126 bugfix (forgotten "this" keyword)
