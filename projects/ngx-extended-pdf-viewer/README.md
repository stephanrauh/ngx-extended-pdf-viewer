...
| (pdfDownloaded) | no | undefined | fires when a user downloads a document. Strictly speaking, it fires when they click the "download" button. Even if the user cancels the download, the event is fired. |
...
| 1.0.0-rc.2 |                                                                                                                                                             #105 when the user downloads a document, the event (pdfDownloaded) is fired.                                                                                                                                                            |
