...
## Breaking changes
- 1.8.0 New required dependency: loadash.deburr. If you haven't got it already, run `npm i loadash.deburr`. Plus, `[showSidebarOnLoad]` has been deprecated. Updated to pdf.js 2.3.200.
...
| (updateFindMatchesCount)     |       off       | This event is call during a find operation. Note that it can be called hundreds or even thousands of time, due to the asynchronous implementation of the find algorithm. It sends a `FindFindResultMatchesCount`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| (updateFindState)            |       off       | This event is called during the find operations. It sends a `FindState`(i.e. `FindState.FOUND`, `FindState.NOT_FOUND`, `FindState.PENDING` or `FindState.WRAPPED`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
