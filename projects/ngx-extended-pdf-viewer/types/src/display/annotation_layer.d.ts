...
export class AnnotationLayer {
     ...
     */
    static "__#20@#setDimensions"(div: HTMLDivElement, { width, height, rotation }: PageViewport): void;
    static "__#20@#setAnnotationCanvasMap"(div: any, annotationCanvasMap: any): void;
}
