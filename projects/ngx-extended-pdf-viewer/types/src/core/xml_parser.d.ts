...
export class SimpleXMLParser extends XMLParserBase {
    ...
    onEndElement(name: any): any;
}
export class XMLParserBase {
    static get _entityRegex(): any;
...
export namespace XMLParserErrorCode {
    ...
    let MalformedElement: number;
    let OutOfMemory: number;
    let UnterminatedAttributeValue: number;
    let UnterminatedElement: number;
    let ElementNeverBegun: number;
}
