...
export function bytesToString(bytes: any): any;
 ...
 */
export function createValidAbsoluteUrl(url: URL | string, baseUrl: URL | string): URL;
...
export class Util {
    ...
    static intersect(rect1: any, rect2: any): any[];
}
