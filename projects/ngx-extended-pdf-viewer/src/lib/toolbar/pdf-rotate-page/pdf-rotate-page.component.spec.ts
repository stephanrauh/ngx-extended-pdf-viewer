...
import { PdfRotatePageComponent } from './pdf-rotate-page.component';
...
describe('PdfRotatePageComponent', () => {
  let component: PdfRotatePageComponent;
  let fixture: ComponentFixture<PdfRotatePageComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfRotatePageComponent);
  ...
  describe('component initialization', () => {
    ...
    it('should have default values', () => {
      expect(component.showRotateButton()).toBe(true);
  ...
  describe('edge cases', () => {
    it('should handle PDF viewer application being undefined', () => {
      ...
      expect(() => {
        TestBed.createComponent(PdfRotatePageComponent);
        TestBed.flushEffects();
      }).not.toThrow();
    });
  });
