...
import { PdfStampEditorComponent } from './pdf-stamp-editor.component';
...
describe('PdfStampEditorComponent', () => {
  let component: PdfStampEditorComponent;
  let fixture: ComponentFixture<PdfStampEditorComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfStampEditorComponent);
  ...
  describe('AbortController lifecycle (#3135)', () => {
    ...
    it('should unsubscribe handler on ngOnDestroy so it stops firing', () => {
      ...
      eventBus.dispatch('annotationeditormodechanged', { mode: 13 });
  ...
  describe('annotationeditormodechanged handler', () => {
    it('should set isSelected when mode matches STAMP (13)', () => {
      jest.useFakeTimers();
      initPdfViewer();
  ...
  describe('onClick', () => {
    ...
    it('should dispatch switchannotationeditormode', () => {
      ...
      expect(eventBus.dispatch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({ mode: AnnotationEditorType.STAMP })
      );
    });

    it('should toggle to NONE when already in STAMP mode', () => {
      mockPDFViewerApplication.pdfViewer.annotationEditorMode = AnnotationEditorType.STAMP;
      component.onClick({ detail: 1 } as any);
      expect(eventBus.dispatch).toHaveBeenCalledWith(
        'switchannotationeditormode',
