...
import { PdfCommentEditorComponent } from './pdf-comment-editor.component';
...
describe('PdfCommentEditorComponent', () => {
  let component: PdfCommentEditorComponent;
  let fixture: ComponentFixture<PdfCommentEditorComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfCommentEditorComponent);
  ...
  describe('AbortController lifecycle (#3135)', () => {
    ...
    it('should unsubscribe handler on ngOnDestroy so it stops firing', () => {
      ...
      eventBus.dispatch('annotationeditormodechanged', { mode: 16 });
  ...
  describe('annotationeditormodechanged handler', () => {
    it('should set isSelected when mode matches POPUP (16)', () => {
      jest.useFakeTimers();
      initPdfViewer();
  ...
  describe('onClick', () => {
    ...
    it('should dispatch switchannotationeditormode', () => {
      ...
      expect(eventBus.dispatch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({ mode: AnnotationEditorType.POPUP })
      );
    });

    it('should toggle to NONE when already in POPUP mode', () => {
      mockPDFViewerApplication.pdfViewer.annotationEditorMode = AnnotationEditorType.POPUP;
      component.onClick({ detail: 1 } as any);
      expect(eventBus.dispatch).toHaveBeenCalledWith(
        'switchannotationeditormode',
