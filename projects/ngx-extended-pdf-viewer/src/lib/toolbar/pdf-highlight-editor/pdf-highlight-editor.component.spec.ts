...
import { PdfHighlightEditorComponent } from './pdf-highlight-editor.component';
...
describe('PdfHighlightEditorComponent', () => {
  let component: PdfHighlightEditorComponent;
  let fixture: ComponentFixture<PdfHighlightEditorComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfHighlightEditorComponent);
  ...
  describe('AbortController lifecycle (#3135)', () => {
    ...
    it('should unsubscribe handler on ngOnDestroy so it stops firing', () => {
      ...
      eventBus.dispatch('annotationeditormodechanged', { mode: 9 });
  ...
  describe('annotationeditormodechanged handler', () => {
    it('should set isSelected when mode matches HIGHLIGHT (9)', () => {
      jest.useFakeTimers();
      initPdfViewer();
  ...
  describe('onClick', () => {
    ...
    it('should dispatch switchannotationeditormode', () => {
      ...
      expect(eventBus.dispatch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({ mode: AnnotationEditorType.HIGHLIGHT })
      );
    });

    it('should toggle to NONE when already in HIGHLIGHT mode', () => {
      mockPDFViewerApplication.pdfViewer.annotationEditorMode = AnnotationEditorType.HIGHLIGHT;
      component.onClick({ detail: 1 } as any);
      expect(eventBus.dispatch).toHaveBeenCalledWith(
        'switchannotationeditormode',
