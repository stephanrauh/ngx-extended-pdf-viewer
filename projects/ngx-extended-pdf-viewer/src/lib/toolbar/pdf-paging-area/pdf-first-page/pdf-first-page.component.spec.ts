...
import { PdfFirstPageComponent } from './pdf-first-page.component';
...
describe('PdfFirstPageComponent', () => {
  let component: PdfFirstPageComponent;
  let fixture: ComponentFixture<PdfFirstPageComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfFirstPageComponent);
  ...
  describe('component initialization', () => {
    ...
    it('should have default values', () => {
      ...
      expect(component.disableFirstPage).toBe(true);
    });
  });
  ...
  describe('AbortController lifecycle (#3135)', () => {
    ...
    it('should unsubscribe handler on ngOnDestroy so it stops firing', () => {
      ...
      expect(component.disableFirstPage).toBe(false);
  ...
  describe('updateUIState', () => {
    it('should set disableFirstPage based on pageNumber being <= 1', () => {
  ...
  describe('firstPage', () => {
    it('should dispatch firstpage event', () => {
      initPdfViewer();

      component.firstPage();
      expect(eventBus.dispatch).toHaveBeenCalledWith('firstpage');
    });

    it('should not throw when PDFViewerApplication is undefined', () => {
      expect(() => component.firstPage()).not.toThrow();
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle PDF viewer application being undefined', () => {
      ...
      expect(() => {
        TestBed.createComponent(PdfFirstPageComponent);
        TestBed.flushEffects();
      }).not.toThrow();
    });
  });
