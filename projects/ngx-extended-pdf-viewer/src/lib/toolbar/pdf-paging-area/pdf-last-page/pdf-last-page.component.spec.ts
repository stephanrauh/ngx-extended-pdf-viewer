...
import { PdfLastPageComponent } from './pdf-last-page.component';
...
describe('PdfLastPageComponent', () => {
  let component: PdfLastPageComponent;
  let fixture: ComponentFixture<PdfLastPageComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfLastPageComponent);
  ...
  describe('component initialization', () => {
    ...
    it('should have default values', () => {
      ...
      expect(component.disableLastPage).toBe(true);
    });
  });
  ...
  describe('AbortController lifecycle (#3135)', () => {
    ...
    it('should unsubscribe handler on ngOnDestroy so it stops firing', () => {
      ...
      expect(component.disableLastPage).toBe(false);

      component.ngOnDestroy();
      component.disableLastPage = true;
  ...
  describe('updateUIState', () => {
    it('should set disableLastPage based on pageNumber equaling pagesCount', () => {
  ...
  describe('lastPage', () => {
    it('should dispatch lastpage event', () => {
      initPdfViewer();

      component.lastPage();
      expect(eventBus.dispatch).toHaveBeenCalledWith('lastpage');
    });

    it('should not throw when PDFViewerApplication is undefined', () => {
      expect(() => component.lastPage()).not.toThrow();
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle PDF viewer application being undefined', () => {
      ...
      expect(() => {
        TestBed.createComponent(PdfLastPageComponent);
        TestBed.flushEffects();
      }).not.toThrow();
    });
  });
