...
import { PdfVerticalScrollModeComponent } from './pdf-vertical-scroll-mode.component';
...
describe('PdfVerticalScrollModeComponent', () => {
  let component: PdfVerticalScrollModeComponent;
  let fixture: ComponentFixture<PdfVerticalScrollModeComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PdfVerticalScrollModeComponent);
  ...
  describe('edge cases', () => {
    it('should handle PDF viewer application being undefined', () => {
      ...
      expect(() => {
        const newFixture = TestBed.createComponent(PdfVerticalScrollModeComponent);
