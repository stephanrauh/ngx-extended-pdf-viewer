...
export const pdfjsVersion = '3.10.550';
export const pdfjsBleedingEdgeVersion = '4.0.718';
...
export let pdfDefaultOptions = {
  ...
  sandboxBundleSrc: () =>
    pdfDefaultOptions.needsES5
      ...
      : `./pdf.sandbox-${getVersionSuffix(assetsUrl(pdfDefaultOptions.assetsFolder))}.mjs`,
  workerSrc: () =>
    pdfDefaultOptions.needsES5
