...
- 27.0.1 #3244 security fix: closes CVE-2026-16633, which allowed a malicious PDF to run JavaScript in the context of the hosting page. Both the stable and the bleeding-edge bundle are patched. Note the XFA half of the issue is reachable with the default settings, so please update. Details: [GHSA-w9hm-4m3m-fxmm](https://github.com/stephanrauh/ngx-extended-pdf-viewer/security/advisories/GHSA-w9hm-4m3m-fxmm)
