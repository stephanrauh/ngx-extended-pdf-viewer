...
- 24.4.5 #2355 / #2985 fixed `pdfViewerService.getSerializedAnnotations()`; fixed `pdfViewerService.addImageToAnnotationLayer()`; added `pdfViewerService.addHighlightToAnnotationLayer()`; #2943 use a different icon for the new "move page up/down" buttons
