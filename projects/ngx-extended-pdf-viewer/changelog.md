...
- 26.0.0-rc.13 #3126 fixed Firefox print preview showing grey placeholders — blob URLs are now kept alive until after printing completes, and a `toDataURL()` fallback is used if `toBlob()` fails
