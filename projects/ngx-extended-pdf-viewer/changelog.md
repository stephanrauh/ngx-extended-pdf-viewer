...
- 26.0.0-rc.2 #3136 added `drawingStarted` and `drawingStopped` annotation editor events that fire when the user starts and stops actively drawing (ink/pencil) or highlighting
