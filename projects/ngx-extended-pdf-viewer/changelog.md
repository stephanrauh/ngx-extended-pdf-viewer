...
- 16.0.0-alpha.4 #1577 fixed bugs introduced when merging pdf.js 3.2; #1653 added `docBaseUrl` to the `pdfDefaultOptions` and documented it; #1638 remove the `printContainer` when `ngOnDestroy` is called; #1610 added `String.at()` to the browser switch checks; #1658 added the "editorInk" cursor icon; #1471 activate the PDF editor; #1629 removed CSS rules that made creating custom buttons difficult (possibly breaking change)
