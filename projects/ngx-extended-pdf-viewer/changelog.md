...
- 28.0.2 #3226 a new CSS variable `--page-placeholder-background-color` lets you remove the grey flash when you scroll to a page that hasn't rendered yet or switch PDFs — set it to `transparent` (or any color) on `ngx-extended-pdf-viewer`.
