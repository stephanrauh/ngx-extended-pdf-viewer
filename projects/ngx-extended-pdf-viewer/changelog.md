...
- 25.6.0-alpha.4 #2843 stop showing "0%" zoom; #2691 store the initial form values to prevent the annoying message "are you sure you want to reload without saving?" (only works for small forms because of lazy page rendering)
