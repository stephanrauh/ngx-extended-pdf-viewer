...
- 21.0.0-alpha.14 address Sonarqube issues; reverted the additions of #1659 because pdf.js has introduced the flag `enableHWA` that does the same as my `activateWillReadFrequentlyFlag` did
