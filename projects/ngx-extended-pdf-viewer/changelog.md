...
- 2.0.0-alpha.1 #194 add an option to display the PDF file without the border (`[removePageBorders]`). Kudos to Balaji Sivaraman for contributing this pull request!
