...
- 26.1.0 updated the bleeding-edge version of pdf.js from 5.4.530 to 5.5.207: page reordering via drag-and-drop in the thumbnail sidebar (including multi-select and paste), page extraction (save/copy/cut/delete selected pages), comment undo/redo support, updated JBIG2 decoder, CCITTFax decoder from pdfium, Brotli decompression support, improved sidebar styling and resizer accessibility, thumbnail hover/current page number styling improvements, high contrast mode (HCM) improvements for thumbnails, MathML accessibility improvements, find-in-page working correctly after page reordering, and updated locale files
